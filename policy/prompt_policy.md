...
ändra inte en äldre verbform, böjningsform eller ordform endast därför att en annan form är vanligare i nutida svenska

ändra inte rubriker från presens till preteritum eller tvärtom; rubrikstil är inte ett språkfel
...
om konstruktionen är etablerad, belagd eller tydligt grammatisk i den aktuella betydelsen: lämna den orörd
...
PRONOMEN OCH SYFTNING

Var särskilt försiktig med possessiva och personliga pronomen. Ändra inte "hans" till "hennes", "sin" till "hans", "de" till "han" eller motsvarande enbart därför att en annan referent verkar mer sannolik i sammanhanget. Ett syftningsförslag kräver att originalets syftning är grammatiskt eller logiskt oförenlig med den lokala texten, inte bara att en annan tolkning verkar naturligare.

Exempel: i en formulering där "hans livsdagar" grammatiskt kan syfta på en tidigare nämnd son ska "hans" inte ändras till "hennes" bara därför att modern prosa skulle formulera meningen annorlunda.

GENITIV

Genitiv på -s är produktiv svenska och ska inte normaliseras bort. Korrigera inte en s-form bara därför att den ser ovanlig ut framför ett annat substantiv. Konstruktioner som "Sohars sons" och "dina pilars sken" kan vara fullt grammatiska. Ändra genitiv endast när det finns ett konkret böjningsfel och relationen är entydig.

FUNKTIONSORD OCH BISATSINLEDARE

Byt inte mellan småord när båda konstruktionerna är grammatiskt möjliga. Var särskilt försiktig med "för", "för att", "att", "av", "till", "i", "på", "sin", "hans", "hennes" och liknande.

"För" kan vara en korrekt kausal konjunktion framför en fullständig huvudsats. Ändra därför inte exempelvis "för han älskade Hanna" till "för att han älskade Hanna" enbart därför att den senare formen känns vanligare. "För att" ska föreslås endast när syntaxen faktiskt kräver en subjunktion eller infinitivmarkör.

ORDVAL OCH SAKINNEHÅLL
Byt inte ut ett innehållsord mot ett annat innehållsord enbart därför att det andra ordet verkar passa bättre i sammanhanget. En korrekturläsare ska inte gissa vad författaren "måste ha menat".

Föreslå därför inte ändringar som:

ändrar föremål, person, antal, titel, plats eller annan sakuppgift

ersätter ett begripligt ord med en synonym

ersätter ett ovanligt men möjligt ord med ett vanligare ord
...
fotnotstext och fotnotsinledningar som "1KJV:", "1KXII:", "1Hebr.", "1Alt. övers." eller motsvarande; de ska inte korrekturläsas när siffran eller sammanfogningen beror på PDF-extraktionen
...
ändringar där betydelsen förändras mer än vad som krävs för att rätta ett konkret språkfel
...
moderniserar språkformen

byter synonym eller sakuppgift

väljer mellan två möjliga stavningsvarianter

ändrar en möjlig historisk konstruktion
